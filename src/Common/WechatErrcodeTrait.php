...
trait WechatErrcodeTrait
{
    public $errorCode = array(
        ...
        40002 => '不合法的凭证类型',//暂无生成权限（非个人主体小程序无权限，未申请 NFC 能力的小程序无权限）
        ...
        40011 => '不合法的视频文件大小',
        40012 => '不合法的缩略图文件大小',
        40013 => '不合法的 AppID ，请开发者检查 AppID 的正确性，避免异常字符，注意大小写，或者不符合绑定关系要求',//生成权限被封禁
        ...
        40163 => 'oauth_code已使用',
        40165 => '参数 path 填写错误，更正后重试',
        40201 => '不正确的URL，一般是开发者未设置回调URL。',
        40202 => '不正确的action',
        40203 => '不正确的check_operator',
        40212 => '参数 query 填写错误 ，query格式遵循 URL 标准，即k1=v1&k2=v2',
        ...
        45007 => '语音播放时间超过限制',
        45008 => '图文消息超过限制',
        45009 => '接口调用超过限制',//调用超过天级别频率限制。可调用clear_quota接口恢复调用额度
        45010 => '创建菜单个数超过限制',
        ...
        85400 => '长期有效 Scheme 达到生成上限10万，不可再生成。',
        85401 => '参数expire_time填写错误，时间间隔大于1分钟且小于1年，更正后重试',
        85402 => '参数env_version填写错误，更正后重试',
        85403 => 'scheme/url link不存在',
        87009 => '无效的签名',
        ...
        9300501 => '物流账号密码错误（bizId and pwd check error）',
        9300502 => '快递公司系统错误',
